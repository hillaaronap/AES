function r=GaloisMultLU(p,j)
q = hex2dec(p)+1;

byTwo = ['00', '02', '04', '06', '08', '0a', '0c', '0e', '10', '12', '14', '16', '18', '1a', '1c', '1e',...
...
byThree = ['00', '03', '06', '05', '0c', '0f', '0a', '09', '18', '1b', '1e', '1d', '14', '17', '12', '11',...
...
byNine = ['00', '09', '12', '1b', '24', '2d', '36', '3f', '48', '41', '5a', '53', '6c', '65', '7e', '77',...
...
byEleven = ['00', '0b', '16', '1d', '2c', '27', '3a', '31', '58', '53', '4e', '45', '74', '7f', '62', '69',...
...
byThirteen = ['00', '0d', '1a', '17', '34', '39', '2e', '23', '68', '65', '72', '7f', '5c', '51', '46', '4b',...
...
byFourteen = ['00', '0e', '1c', '12', '38', '36', '24', '2a', '70', '7e', '6c', '62', '48', '46', '54', '5a',...
...
switch j
	case 2
        ret = byTwo(2*q-1:2*q);
	case 3
        ret = byThree(2*q-1:2*q);
    case 9
        ret = byNine(2*q-1:2*q);
    case 11
        ret = byEleven(2*q-1:2*q);
    case 13
        ret = byThirteen(2*q-1:2*q);
    case 14
        ret = byFourteen(2*q-1:2*q);
    otherwise
        fprintf('Galois Multiplication only supported for {2,3,9,11,13,14}');
end;
r=ret;
